...
#include "AA29/Controller/AIController/ScriptedController/Bot/Bot.h"
...
public:
	...
	//UPROPERTY()										AAI_Thought* NextThought;					//var AI_Thought NextThought;
	...
	void PostBeginPlay();
	void Think();
	void AddThought(AAI_Thought* Thought);
