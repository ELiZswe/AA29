...
#include "AA29/Keypoint/AIScript/ScriptedSequence/ScriptedTrigger/ScriptedTrigger.h"

AScriptedTrigger::AScriptedTrigger(const FObjectInitializer& objectInitializer)
