...
#include "AA29/Keypoint/AIScript/ScriptedSequence/FSTS_ScriptedSequence/FSTS_ScriptedSequence.h"

AFSTS_ScriptedSequence::AFSTS_ScriptedSequence(const FObjectInitializer& objectInitializer)
