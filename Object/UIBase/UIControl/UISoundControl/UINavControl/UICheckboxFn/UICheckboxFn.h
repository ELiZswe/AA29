...
#include "UICheckboxFn.generated.h"

/**
 * 
 */
UCLASS()
class AA29_API UUICheckboxFn : public UUINavControl
{
	GENERATED_BODY()
public:
	UUICheckboxFn();
	...
	UPROPERTY()										FString _sFuncName;						//var string _sFuncName;
	...
	void SetFuncName(FString funcname);
	bool IsSelected();
