...
UAADeploy_Internet::UAADeploy_Internet()
{
	...
	*/
	//FilterAndServerListPanel = AABrowser_FilterAndServerlistPanel'AGP_Interface.AADeploy_Internet.FilterAndServerList';
	//FilterSetPanel = AABrowser_FilterSetPanel'AGP_Interface.AADeploy_Internet.FilterSet';
	//PlayerServerSearchPanel = AABrowser_PlayerServerSearchPanel'AGP_Interface.AADeploy_Internet.PlayerServerSearch';
	//UpdateJoinAndPBPanel = AABrowser_UpdateJoinAndPBPanel'AGP_Interface.AADeploy_Internet.UpdateJoinAndPB';
	PanelCaptionBase = "AA Browser";
	//ServerCount = GUILabel'AGP_Interface.AADeploy_Internet.ServerCountLabel';
