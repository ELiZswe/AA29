...
#include "AA29/Object/GUI/GUIComponent/GUIMultiComponent/GUIPanel/GUITabPanel/AATabPanel/AAMainSubPanel/AABackgroundSubPanel/AAMissionsSubPanel/AADeploy_Missions/AADeploy_Missions.h"

UAADeploy_Missions::UAADeploy_Missions()
{
...
bool UAADeploy_Missions::UseTraining(int32 Tour)
{
	//return (!PlayerOwner().Level.GetTourIsTraining(Tour));
	return false;    //FAKE   /ELiZ
}

void UAADeploy_Missions::SetStatusCaption(int32 Status)
{
	/*
	switch (Status)
	{
...
bool UAADeploy_Missions::ButtonClick(UGUIComponent* Sender)
{
	/*
