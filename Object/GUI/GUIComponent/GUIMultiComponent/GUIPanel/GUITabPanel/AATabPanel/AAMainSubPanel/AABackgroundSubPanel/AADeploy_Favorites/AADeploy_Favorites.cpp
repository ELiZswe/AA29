...
UAADeploy_Favorites::UAADeploy_Favorites()
{
	...
	AddFavoriteServerButton->FontScale = EFontScale::FNS_Small;
	...
	AddBuddyButton->FontScale = EFontScale::FNS_Small;
	...
	RemoveSelectedButton->FontScale = EFontScale::FNS_Small;
	...
	LowerBackground->Image = LoadObject<UMaterialInstance>(NULL, TEXT("MaterialInstanceConstant'/Game/AmericasArmy/Textures/T_AA2_UI/Menu/backgroundfil_Mat.backgroundfil_Mat'"), NULL, LOAD_None, NULL);
