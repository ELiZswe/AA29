...
UAADeploy_LAN::UAADeploy_LAN()
{
	...
	PlayerNameBackground->Image=Texture'T_AA2_UI.Menu.backgroundfill';
	PlayerNameBackground->ImageStyle=1;
	PlayerNameBackground->ImageRenderStyle=1;
	...
	*/
	//ServersPlayersRulesPanel = AABrowser_ServersPlayersRulesPanel'AGP_Interface.AADeploy_LAN.ServersPlayersRules';
	//UpdateJoinAndPBPanel = AABrowser_UpdateJoinAndPBPanel'AGP_Interface.AADeploy_LAN.UpdateJoinAndPB';
	//PlayerNameBackgroundBorder = GUIImage'AGP_Interface.AADeploy_LAN.PlayerNameBackground';
	//PlayerNameLabel = GUILabel'AGP_Interface.AADeploy_LAN.LANPlayerName';
	//PlayerNameEditBox = GUIEditBox'AGP_Interface.AADeploy_LAN.PlayerName';
	//ServerCount = GUILabel'AGP_Interface.AADeploy_LAN.ServerCountLabel';
	bIsLAN = true;
