...
#include "AATab_AAScoreboard_DefenseTeam.generated.h"
...
UCLASS()
class AA29_API UAATab_AAScoreboard_DefenseTeam : public UAATeamGamePanel
{
	GENERATED_BODY()
public:
	UAATab_AAScoreboard_DefenseTeam();

	UPROPERTY()					int32					LastTeamID;			//var int32 LastTeamID;
	UPROPERTY()					UGUILabel*				l_Defense;			//var XInterface.GUILabel l_Defense;
