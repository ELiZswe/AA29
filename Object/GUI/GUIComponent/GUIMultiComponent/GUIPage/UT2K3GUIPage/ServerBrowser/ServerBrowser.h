...
public:
	...
	UPROPERTY(EditAnywhere, config)		bool			bOnlyShowStandard;			//var() config bool bOnlyShowStandard;
	UPROPERTY(EditAnywhere, config)		bool			bOnlyShowNonPassword;		//var() config bool bOnlyShowNonPassword;
	UPROPERTY(EditAnywhere, config)		bool			bDontShowFull;				//var() config bool bDontShowFull;
	UPROPERTY(EditAnywhere, config)		bool			bDontShowEmpty;				//var() config bool bDontShowEmpty;
	UPROPERTY(EditAnywhere, config)		bool			bDontShowWithBots;			//var() config bool bDontShowWithBots;
	UPROPERTY(EditAnywhere, config)		FString			DesiredMutator;				//var() config FString DesiredMutator;
	UPROPERTY(EditAnywhere, config)		FString			DesiredMutator2;			//var() config FString DesiredMutator2;
	UPROPERTY(EditAnywhere, config)		FString			CustomQuery;				//var() config FString CustomQuery;
	UPROPERTY(EditAnywhere, config)		int32			MinGamespeed;				//var() config int32 MinGamespeed;
	UPROPERTY(EditAnywhere, config)		int32			MyNMaxGamespeedewNick;		//var() config int32 MaxGamespeed;
