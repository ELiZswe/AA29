...
#include "AA29/Object/GUI/GUIComponent/GUIMultiComponent/GUIPage/AAGUIPage/PopupPageBase/MessageWindow/AAGenericMessageBox/AAMissionCompletePageSFMOUT/AAMissionCompletePageSFMOUT.h"
#include "AA29/Object/GUI/GUIComponent/GUIButton/GUIButton.h"
#include "AA29/Object/GUI/GUIComponent/GUILabel/GUILabel.h"

UAAMissionCompletePageSFMOUT::UAAMissionCompletePageSFMOUT()
{
	...
	//SaveAndTryAgainButton->OnClick=AAMissionCompletePageSFMOUT.InternalOnClick;
	...
	//RetryButton->OnClick=AAMissionCompletePageSFMOUT.InternalOnClick;
	...
	//CancelButton->OnClick=AAMissionCompletePageSFMOUT.InternalOnClick;
	...
	OkButton->Hint = "Upload your results, which will be posted to the MOUT scoreboard.";
	OkButton->WinTop = 0.67;
	OkButton->WinLeft = 0.15;
	OkButton->WinWidth = 0.3;
	//OkButton->OnClick=AAMissionCompletePageSFMOUT.InternalOnClick;
...
void UAAMissionCompletePageSFMOUT::InitComponent(UGUIController* MyController, UGUIComponent* MyOwner)
{
	/*
...
bool UAAMissionCompletePageSFMOUT::InternalOnClick(UGUIComponent* Sender)
{
	/*
	switch (Sender)
	{
...
bool UAAMissionCompletePageSFMOUT::InternalOnKeyEvent(uint8& Key, uint8& State, float Delta)
{
	/*
	if ((State == 3) && (Key == 11))
	{
...
void UAAMissionCompletePageSFMOUT::HandleObject(UObject* obj, UObject* OptionalObj_1, UObject* OptionalObj_2)
{
	/*
...
FString UAAMissionCompletePageSFMOUT::GetDataString()
{
	return l_Text2->Caption;
}

void UAAMissionCompletePageSFMOUT::SetDataString(FString str)
{
	l_Text2->Caption = str;
	//Super::SetDataString(str);
}

void UAAMissionCompletePageSFMOUT::SaveAndTryAgain()
{
	bTryAgain = true;
	OK();
}

void UAAMissionCompletePageSFMOUT::OK()
{
	/*
	b_OK.DisableMe();
	b_Cancel.DisableMe();
...
void UAAMissionCompletePageSFMOUT::Timer()
{
	/*
...
void UAAMissionCompletePageSFMOUT::Cancel()
{
...
void UAAMissionCompletePageSFMOUT::Retry()
{
