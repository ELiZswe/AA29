...
public:
	...
	void Sort();
	void SilentSetIndex(int32 NewIndex);
	...
	void AddLinkObject(UGUIComponent* NewObj, bool bNoCheck);
	...
	void InternalOnKeyEvent(uint8& Key, uint8& KeyState, float Delta);
	bool Up();
	bool Down();
	bool MoveRight();
	bool MoveLeft();
	...
	void InternalOnRightClick(UGUIComponent* Sender);
