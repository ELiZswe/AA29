...
public:
	...
	UPROPERTY()						TArray<FString> ExtraSpecialForcesDescriptions;			//var TArray<FString> ExtraSpecialForcesDescriptions;
	...
	UPROPERTY()						TArray<FString> IconDescriptions;						//var() localized TArray<FString> IconDescriptions;
