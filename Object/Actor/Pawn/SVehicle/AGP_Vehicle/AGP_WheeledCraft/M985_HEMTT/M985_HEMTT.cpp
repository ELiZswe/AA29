...
#include "AA29/Object/Actor/Pawn/SVehicle/AGP_Vehicle/AGP_WheeledCraft/M985_HEMTT/M985_HEMTT.h"
...
AM985_HEMTT::AM985_HEMTT()
{
	...
	//StartUpSound = Sound'S_AA2_Vehicles.HEMTT.HEMMT_Start_4';
	StartUpForce = "PRVStartUp";
	ShutDownForce = "PRVShutDown";
	//DestroyedVehicleMesh = StaticMesh'M_AA2_Vehicles.HEMTT.HEMTT_Cargo_Static';
	...
	//HealthMax = 1000;
	//Health = 1000;
	//Mesh = SkeletalMesh'A_AGP_Vehicles.M985_Cargo_HEMTT';
	//CollisionRadius = 380;
	//CollisionHeight = 120;
	//KParams = KarmaParamsRBFull'AGP_Vehicles.M985_HEMTT.KParams0';
}
