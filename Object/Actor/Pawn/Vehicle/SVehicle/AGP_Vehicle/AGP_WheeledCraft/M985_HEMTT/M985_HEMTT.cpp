...
AM985_HEMTT::AM985_HEMTT()
{
	...
	//Body_Right_1->DamageStates(1) = ({ "DS1_body_right_1_bone","None","None","None","None","None","None","None",0,0,0,0,0,0,0,0,0.9,0,Class'AGP_Effects.VehicleLightSmoke',class'None',class'AGP_Vehicles.VPE_EngineDamage' });
	//Body_Right_1->DamageStates(2) = ({ "DS2_body_right_1_bone","None","None","None","None","None","None","None",0,0,0,0,0,0,0,0,0.3,0,Class'AGP_Effects.VehicleFireHeavySmokeSmall',class'None',class'AGP_Vehicles.VPE_EngineDamage' });
	...
	//Body_Left_1->DamageStates(1) = ({ "DS1_body_left_1_bone","None","None","None","None","None","None","None",0,0,0,0,0,0,0,0,0.9,0,Class'AGP_Effects.VehicleLightSmoke',class'None',class'AGP_Vehicles.VPE_EngineDamage' });
	//Body_Left_1->DamageStates(2) = ({ "DS2_body_left_1_bone","None","None","None","None","None","None","None",0,0,0,0,0,0,0,0,0.3,0,Class'AGP_Effects.VehicleFireHeavySmokeSmall',class'None',class'AGP_Vehicles.VPE_EngineDamage' });
	...
	//Winshield_Left->DamageStates(1) = ({ "ds1_windshield_left_1_bone","None","None","None","None","None","None","None",0,0,0,0,0,0,0,0,0.5,0,Class'AGP_Effects.VehicleGlassShatter',class'None',class'None' });
	...
	StartUpSound = LoadObject<USoundBase>(NULL, TEXT("SoundCue'/Game/AmericasArmy/Sounds/S_AA2_Vehicles/HEMTT/HEMMT_Start_4_Que.HEMMT_Start_4_Que'"), NULL, LOAD_None, NULL);
	StartUpForce = "PRVStartUp";
	ShutDownForce = "PRVShutDown";
	DestroyedVehicleMesh = LoadObject<UStaticMesh>(NULL, TEXT("StaticMesh'/Game/AmericasArmy/Meshes/M_AA2_Vehicles/HEMTT/HEMTT_Cargo_Static.HEMTT_Cargo_Static'"), NULL, LOAD_None, NULL);
	...
	VehiclePositionString = "in a M985 HEMTT";
	VehicleNameString = "M985 HEMTT";
...
/*
void AM985_HEMTT::StaticPrecache(LevelInfo L)
{
	StaticPrecache(L);
...
void AM985_HEMTT::UpdatePrecacheStaticMeshes()
{
	Super::UpdatePrecacheStaticMeshes();
}

void AM985_HEMTT::UpdatePrecacheMaterials()
{
	/*
