...
#include "WF_EL_M2RangeStation.generated.h"

class AFSTS_WeaponPickup;
class ACounter;

UCLASS()
class AA29_API AWF_EL_M2RangeStation : public AWF_EL_MasterScript
{
	GENERATED_BODY()
public:
	AWF_EL_M2RangeStation();


	UPROPERTY()   FString NumRoundsPracticeMsg;			//var localized string NumRoundsPracticeMsg;
