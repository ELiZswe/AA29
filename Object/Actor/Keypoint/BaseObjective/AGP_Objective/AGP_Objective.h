...
UCLASS()
class AAGP_Objective : public ABaseObjective
{
	GENERATED_BODY()
public:
	...
	UPROPERTY()																		USoundBase*								sndESSObjectiveCompletionAcknowledgement;		//var Sound sndESSObjectiveCompletionAcknowledgement;
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "NPCReinforcements")		TArray<FNPCObjectiveResponse>			anpcoaNPCResponse;								//var(NPCReinforcements) array<NPCObjectiveResponse> anpcoaNPCResponse;
	...
	//UPROPERTY()																		TSubclassOf<ASoldierClass>				MustBeClass;									//var() class<SoldierClass> MustBeClass;
	...
	bool IsHigherPriorityThan(ABaseObjective* otherb);
	...
	TArray<AAGP_Objective*> getLinkedArray();
	void ActivateFromRadio(AHumanController* aInstigator);
	bool isOnRadar();
