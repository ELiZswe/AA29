...
UCLASS()
class AUdpGamespyUplink : public AUdpLink
{
	GENERATED_BODY()
public:
	AUdpGamespyUplink();
	...
	bool ParseNextQuery(FString aQuery, FString &QueryType, FString &QueryValue, FString &QueryRest, FString &FinalPacket);
	FString ParseQuery(FIpAddr Addr, FString QueryStr, int32 QueryNum, int32 &PacketNum);
	bool SendQueryPacket(FIpAddr Addr, FString SendString, int32 QueryNum, int32 PacketNum, FString FinalPacket);
};
