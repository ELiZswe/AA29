...
AM24MuzzleFlash::AM24MuzzleFlash()
{
	...
	MeshEmitter0->StartSizeRange = FRangeVector({ {0.25, 0.25}, {0.25, 0.25}, {0.25, 0.25} });
...
void AM24MuzzleFlash::BeginPlay()
{
	//Super::BeginPlay();
