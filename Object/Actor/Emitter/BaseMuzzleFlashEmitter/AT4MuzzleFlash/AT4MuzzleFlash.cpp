...
#include "AT4MuzzleFlash.h"
#include "AA29/Object/BaseEmitter/ParticleEmitter/SpriteEmitter/SpriteEmitter.h"

AAT4MuzzleFlash::AAT4MuzzleFlash()
{
	...
	SpriteEmitter7->StartLocationOffset = FVector(0, -88, 0);
	SpriteEmitter7->StartSpinRange = FRangeVector({ {32600, 0}, {0, 0}, {0, 0} });
	//SpriteEmitter7->SizeScale[0]=FParticleTimeScale({0,1});
	//SpriteEmitter7->SizeScale[1]=FParticleTimeScale({1,3});
	SpriteEmitter7->StartSizeRange = FRangeVector({ {8, 10}, {100, 100}, {100, 100} });
	SpriteEmitter7->InitialParticlesPerSecond = 55;
	SpriteEmitter7->DrawStyle = EParticleDrawStyle::PTDS_Brighten;
	SpriteEmitter7->Texture = LoadObject<UMaterialInstance>(NULL, TEXT("MaterialInstanceConstant'/Game/AmericasArmy/Textures/T_AA2_FX/Particles/fx_particle_startblast01_Mat.fx_particle_startblast01_Mat'"), NULL, LOAD_None, NULL);
	SpriteEmitter7->LifetimeRange = FRange({ 0.05, 0.05 });
	...
	//SpriteEmitter8->ColorScale[0]=FParticleColorScale({0,FColor(138, 143, 149, 211)});
	//SpriteEmitter8->ColorScale[1]=FParticleColorScale({1,FColor(138, 143, 149, 211)});
	...
	SpriteEmitter8->StartSizeRange = FRangeVector({ {50, 50}, {100, 100}, {100, 100} });
	...
	//SpriteEmitter9->ColorScale[0]=FParticleColorScale({0,FColor(138, 143, 149, 211)});
	//SpriteEmitter9->ColorScale[1]=FParticleColorScale({1,FColor(138, 143, 149, 211)});
	SpriteEmitter9->FadeOutStartTime = 0.5;
	SpriteEmitter9->MaxParticles = 1;
	SpriteEmitter9->StartLocationOffset = FVector(0, 33, 0);
	...
	SpriteEmitter9->StartSizeRange = FRangeVector({ {40, 40}, {100, 100}, {100, 100} });
	...
	SpriteEmitter12->MaxParticles = 7;
	SpriteEmitter12->StartLocationOffset = FVector(0, -22, 0);
	...
	SpriteEmitter12->InitialParticlesPerSecond = 111;
	...
	SpriteEmitter13->Acceleration = FVector(5, 5, -5);
	//SpriteEmitter13->ColorScale[0]=FParticleColorScale({0,FColor(138, 143, 149, 122)});
	//SpriteEmitter13->ColorScale[1]=FParticleColorScale({1,FColor(138, 143, 149, 122)});
	SpriteEmitter13->FadeOutStartTime = 0.5;
	SpriteEmitter13->MaxParticles = 4;
	SpriteEmitter13->StartLocationRange = FRangeVector({ {-99, -99}, {-119, -99}, {-111, 111} });
	SpriteEmitter13->UseRotationFrom = EParticleRotationSource::PTRS_Actor;
	SpriteEmitter13->SpinsPerSecondRange = FRangeVector({ {0.01, 0.07}, {0, 0}, {0, 0} });
	SpriteEmitter13->StartSpinRange = FRangeVector({ {0, 32600}, {0, 0}, {0, 0} });
	//SpriteEmitter13->SizeScale[0]=FParticleTimeScale({0,1});
	//SpriteEmitter13->SizeScale[1]=FParticleTimeScale({1,2});
	SpriteEmitter13->StartSizeRange = FRangeVector({ {66, 99}, {100, 100}, {100, 100} });
	SpriteEmitter13->InitialParticlesPerSecond = 44;
	...
	SpriteEmitter13->LifetimeRange = FRange({ 5, 7 });
	SpriteEmitter13->StartVelocityRange = FRangeVector({ {0, 0}, {-14, -11}, {0, 0} });
	Emitters = { SpriteEmitter1,SpriteEmitter4,SpriteEmitter5,SpriteEmitter6,SpriteEmitter7,SpriteEmitter8,SpriteEmitter9,SpriteEmitter11,SpriteEmitter12,SpriteEmitter13 };
	LifeSpan = 10;
};

void AAT4MuzzleFlash::SpawnLight()
{
	/*
	local Emitter E;
