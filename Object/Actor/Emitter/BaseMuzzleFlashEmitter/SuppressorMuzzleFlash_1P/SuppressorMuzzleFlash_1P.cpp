...
#include "SuppressorMuzzleFlash_1P.h"
#include "AA29/Object/BaseEmitter/ParticleEmitter/SpriteEmitter/SpriteEmitter.h"

ASuppressorMuzzleFlash_1P::ASuppressorMuzzleFlash_1P()
{
	...
	SpriteEmitter0->StartSizeRange = FRangeVector({ {0, 2}, {100, 100}, {100, 100} });
	...
	SpriteEmitter1->StartVelocityRange = FRangeVector({ {0, 0}, {-33, -44}, {188, 199} });
