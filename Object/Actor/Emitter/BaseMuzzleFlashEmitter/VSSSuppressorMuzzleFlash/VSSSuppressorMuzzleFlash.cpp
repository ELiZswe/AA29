...
AVSSSuppressorMuzzleFlash::AVSSSuppressorMuzzleFlash()
{
	...
	//MeshEmitter0->SizeScale[0]=FParticleTimeScale({0.5,0.25});
	//MeshEmitter0->SizeScale[1]=FParticleTimeScale({1,0.05});
	MeshEmitter0->StartSizeRange = FRangeVector({ {0.1, 0.15}, {0.15, 0.2}, {0.1, 0.15} });
	...
	SpriteEmitter1->StartVelocityRange = FRangeVector({ {0, 0}, {188, 199}, {33, 44} });
...
void AVSSSuppressorMuzzleFlash::BeginPlay()
{
	//Super::BeginPlay();
