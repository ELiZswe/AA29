...
public:
	...
	UFUNCTION(BlueprintCallable)		APlayerController* GetPlayerFromID(int32 iPlayerID);
	...
	UFUNCTION(BlueprintCallable)		bool TournamentAssignClass(FString sPlayerName, int32 iUnitID, int32 iSlot);
	UFUNCTION(BlueprintCallable)		bool TournamentRemoveClass(FString sPlayerName, int32 iUnitID, int32 iSlot);
	...
	UFUNCTION(BlueprintCallable)		AVehicle* DHFindViewHelicopter(FString sNPCTag);
	...
	UPROPERTY()					ANPCBaseController*				LastReportableNPC;					//var NPCBaseController LastReportableNPC;
	...
	UPROPERTY()					TArray<float>					afpTimePlayedPercent;				//var float afpTimePlayedPercent;
	...
	UPROPERTY()					TArray<float>					afpSkillPerRound;					//var float afpSkillPerRound;
	...
	UPROPERTY()					UGUIPage*						guipStats;			//var XInterface.GUIPage guipStats;
	UPROPERTY()					UGUIPage*						guipCommandPost;	//var XInterface.GUIPage guipCommandPost;
	...
	UPROPERTY()					FAuthSurvey			CurrentSurvey;						//var Actor.AuthSurvey CurrentSurvey;
	...
	UPROPERTY()					UUIHUDCompass*						_cHUDCompass;					//var AGP_UI.UIHUDCompass _cHUDCompass;
	UPROPERTY()					UHUDCommoInfo*						_cHUDCommoInfo;					//var HUDCommoInfo _cHUDCommoInfo;
