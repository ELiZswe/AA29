...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite)		UaDamageType*	ProtectionType;					//var() class<DamageType> ProtectionType;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)		int32			ArmorAbsorption;				//var() int32 ArmorAbsorption;
	UPROPERTY(EditAnywhere, BlueprintReadWrite)		int32			AbsorptionPriority;				//var() int32 AbsorptionPriority;
