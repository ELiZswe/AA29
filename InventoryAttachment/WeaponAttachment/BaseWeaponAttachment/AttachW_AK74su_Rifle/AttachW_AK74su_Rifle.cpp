...
#include "AttachW_AK74su_Rifle.h"
...
AAttachW_AK74su_Rifle::AAttachW_AK74su_Rifle()
{
	...
	Mesh								= LoadObject<class USkeletalMesh>(NULL, TEXT("/Game/AmericasArmy/Animations/A_AA2_Weapons3P/aks74u_3P.aks74u_3P"), NULL, LOAD_None, NULL);
}