...
#include "AttachW_M9_Pistol.h"
#include "AA29/InventoryAttachment/WeaponAttachment/BaseWeaponAttachment/PistolWeaponAttachment/AttachW_Makarov_Pistol/AttachW_Makarov_Pistol.h"
...
AAttachW_M9_Pistol::AAttachW_M9_Pistol()
{
	...
	EnemyAttachmentClass			= AAttachW_Makarov_Pistol::StaticClass();
	Mesh							= LoadObject<class USkeletalMesh>(NULL, TEXT("/Game/AmericasArmy/Animations/A_AA2_Weapons3P/m9_3p.m9_3p"), NULL, LOAD_None, NULL);
}