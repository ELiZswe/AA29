...
public:
		...
		UPROPERTY(EditAnywhere, globalconfig)	int32 iMinBanChangesToUpdate;						//var globalconfig int iMinBanChangesToUpdate;
		UPROPERTY(EditAnywhere, globalconfig)	FString sMasterBanListPassword;						//var globalconfig string sMasterBanListPassword;
		UPROPERTY(EditAnywhere, globalconfig)	FString sMasterBanListUserName;						//var globalconfig string sMasterBanListUserName;
		UPROPERTY(EditAnywhere, globalconfig)	bool bFallbackToBanNameIfNoPBGUID;					//var globalconfig bool bFallbackToBanNameIfNoPBGUID;
		UPROPERTY(EditAnywhere, globalconfig)	bool bUpdateMasterBanListViaFTP;					//var globalconfig bool bUpdateMasterBanListViaFTP;
		UPROPERTY(EditAnywhere, globalconfig)	bool bUpdateMasterBanList;							//var globalconfig bool bUpdateMasterBanList;
		UPROPERTY(EditAnywhere, globalconfig)	bool bUseNewBanListFormat;							//var globalconfig bool bUseNewBanListFormat;
		UPROPERTY(EditAnywhere, globalconfig)	FString asTeamPasswords;							//var globalconfig string asTeamPasswords;
		UPROPERTY(EditAnywhere, globalconfig)	bool bAllowMaybeFail;								//var globalconfig bool bAllowMaybeFail;
		UPROPERTY(EditAnywhere, globalconfig)	bool bDontKickLastPlayer;							//var globalconfig bool bDontKickLastPlayer;
		...
		void CheckTimestampExpired(int32 low_word_part, int32 high_word_part, int32 secs_until);
		void LoadOldBanList();
		void SaveOldBanList();
		...
		void BanListCheckPlayerBanStatus(FString sPlayerName, FString sPBGUID);
		void BanListQueryPlayerBanStatus(FString sPlayerName, FString sPBGUID);
		...
		void CheckIPPolicy(FString Address);
		...
		void GetKickPenalty(FString Reason);
		void DoKick();
		void Timer();
		...
		void GetBanLength(int32 iBanItem);
		void Unban(APlayerController* PCAdmin, int32 Index);
		void BanListLoad();
		void BanListParseLine(FString S);
